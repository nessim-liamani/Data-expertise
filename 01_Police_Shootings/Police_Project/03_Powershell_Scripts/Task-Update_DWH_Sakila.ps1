...
$serverName = "Laptop_Nessim"
$databaseName = "DWH_Sakila"
$sqlUsername = "root"
$sqlPassword = "root"

# Execution and log file information
$sqlFilePath = "C:\Users\nessi\OneDrive\Documents\DA2024_Projects\python_workspace\02_SSIS\Exercices SSIS\Ex_23_Sakila_DWH\01-DWH_Sakila-DB\01-04-DWH_Sakila-DML.sql"
$logDirectory = "C:\Users\nessi\OneDrive\Documents\DA2024_Projects\python_workspace\02_SSIS\Exercices SSIS\Ex_23_Sakila_DWH\02-DWH-TaskScheduling\Logs"
$logFilePath = Join-Path -Path $logDirectory -ChildPath "$(Get-Date -Format 'yyyyMMdd_HHmmss')_DWH_Sakila_Log.log"
$errorLogFilePath = Join-Path -Path $logDirectory -ChildPath "$(Get-Date -Format 'yyyyMMdd_HHmmss')_DWH_Sakila_ErrorLog.log"
